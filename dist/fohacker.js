...
(() => {
  ...
  // node_modules/.deno/jquery@3.7.1/node_modules/jquery/dist/jquery.js
  var require_jquery = __commonJS({
    "node_modules/.deno/jquery@3.7.1/node_modules/jquery/dist/jquery.js"(exports, module) {
  ...
  var Renderer = class _Renderer {
    ...
    static emptyTerminalCode() {
      (0, import_jquery.default)(".terminal .code").empty();
    }
    static emptyInfo() {
      (0, import_jquery.default)(".info").empty();
    }
    static appendInputSpanToInfo() {
      (0, import_jquery.default)(".info").append('<span class="input">&nbsp</span>');
    }
    static createPointersForEachTerminalLinenumber(terminalData, lineNumber) {
      (0, import_jquery.default)(".terminal .linenumber").each(function(_key, value) {
        for (let i = 0; i < terminalData.rowsPerColumn; i++) {
          lineNumber = (parseInt(lineNumber, terminalData.rowsPerColumn) + i * 12).toString(16).toUpperCase();
          ...
          if (i === 15) {
            _Renderer.appendLineNumberSpan(value, lineNumber, true);
          } else {
            _Renderer.appendLineNumberSpan(value, lineNumber, false);
          }
        }
      });
    }
    static appendLineNumberSpan(value, lineNumber, isLastLine) {
      if (isLastLine) {
        (0, import_jquery.default)(value).append("<span>0x" + lineNumber + "</span>");
      } else {
        (0, import_jquery.default)(value).append("<span>0x" + lineNumber + "</span><br>");
      }
    }
    ...
    static emptyPerklist() {
      (0, import_jquery.default)(".perklist").empty();
    }
  };
  ...
  var passwords = function() {
    return {
      ...
      5: new dictionary_default([
        "WOUND"
      ]),
      6: new dictionary_default([
        "WEAPON"
      ]),
      7: new dictionary_default([
        "ABCDEFG"
      ]),
      8: new dictionary_default([
        "ABCDEFGH"
      ])
    };
  };
  ...
  var perk_default = Perk;

  // src/classes/terminaldata.js
  var TerminalData = class {
    constructor() {
      this.rowsPerColumn = 16;
      this.columns = 2;
      this.dataPerColumn = 12;
      this.code = [];
      this.markup = [];
    }
    maxCharacters() {
  ...
  var terminaldata_default = TerminalData;
  ...
  DudHelper.startDuds = "<([{";
  DudHelper.endDuds = ">)]}";
  var dudhelper_default = DudHelper;
  ...
  var Game = class {
    constructor() {
      this.gameData = new gamedata_default();
    ...
    levelUp() {
      ...
      while (this.gameData.experience > nextExp) {
        ...
        if (possibleOverhead <= 0) {
          ...
          renderer_default.addLevelUpBeforeInfoInput();
    ...
    addExperience(words) {
      ...
      renderer_default.addExpBeforeInfoInput(addExp);
      this.levelUp();
    }
    getDifficulty() {
    ...
    updateUI() {
      ...
      (0, import_jquery2.default)("#attempts .attempt").detach();
      for (let i = 0; this.gameData.attempts > i; i++) {
        renderer_default.addAttemptBlock();
      }
      renderer_default.emptyPerklist();
      renderer_default.showSkillpointAmount(this.gameData.skillpoints);
      import_jquery2.default.each(perks, function(key, perk) {
        if (perk.meetsRequirements) {
          ...
          renderer_default.appendPerkBoxToPerklist(classes, key, perk, description);
        }
      });
      (0, import_jquery2.default)(".perklist").append();
      const _this = this;
      (0, import_jquery2.default)(".perkdiv").on("click", function() {
        if (_this.gameData.skillpoints > 0) {
          const perkid = (0, import_jquery2.default)(this).data("id");
    ...
    clearOld() {
      renderer_default.emptyTerminalLinenumber();
      renderer_default.emptyTerminalCode();
      this.gameData.attempts = 4;
      this.gameData.currentPasswords = this.gameData.passwords()[this.gameData.difficulty];
      renderer_default.emptyInfo();
      renderer_default.appendInputSpanToInfo();
    }
    ...
    createCurrentPasswords() {
      ...
      this.gameData.currentPasswords = new dictionary_default(currentPasswords);
    }
    addPasswordsToData() {
      ...
      while (tempPasswords.length > 0) {
        ...
        if (code) {
          if (columnIndex + this.gameData.difficulty > this.terminalData.dataPerColumn) {
            continue;
    ...
    addHtml() {
      ...
      for (let rowIndex = 0; this.terminalData.code.length > rowIndex; rowIndex++) {
        ...
        (0, import_jquery2.default)(selector).append('<span id="span' + rowIndex + '"></span><br>');
        (0, import_jquery2.default)("#span" + rowIndex).html(lineValue);
    ...
    addScript() {
      (0, import_jquery2.default)(".code .word").on("mouseover", function(event) {
        const passwordHovered = event.target.textContent;
        console.debug("Hovering: " + passwordHovered);
        (0, import_jquery2.default)(".info .input").attr("data-content", passwordHovered);
      });
      (0, import_jquery2.default)(".code .word").on("mouseout", function() {
        console.debug("End hover");
        (0, import_jquery2.default)(".info .input").attr("data-content", "");
      });
    }
    createTerminal() {
      const _this = this;
      ...
      this.addScript();
      if (perks[0].level >= 2) {
        (0, import_jquery2.default)(".code .word").each(function() {
          if (_this.gameData.password == (0, import_jquery2.default)(this).data("word")) {
            (0, import_jquery2.default)(this).addClass("highlight");
          }
        });
      }
      (0, import_jquery2.default)("ul.tabs").each(function() {
        ...
        $links.not($active).each(function() {
          (0, import_jquery2.default)(this.hash).hide();
        });
        (0, import_jquery2.default)(this).on("click", "a", function(e) {
          $active.removeClass("active");
          $content.hide();
          $active = (0, import_jquery2.default)(this);
          $content = (0, import_jquery2.default)(this.hash);
          $active.addClass("active");
          $content.show();
          e.preventDefault();
        });
      ...
      const linebreak = (0, import_jquery2.default)(".linebreak");
      linebreak.on("mouseenter", function() {
        const dataWord = (0, import_jquery2.default)(this).data("word");
        const siblings = (0, import_jquery2.default)('[data-word="' + dataWord + '"]');
        (0, import_jquery2.default)(siblings).each(function() {
          (0, import_jquery2.default)(this).css("background-color", "#82FA58");
          (0, import_jquery2.default)(this).css("color", "#0B1907");
        });
      }, function() {
        linebreak.css("background-color", "#0B1907");
        linebreak.css("color", "#82FA58");
      });
      const pagebreak = (0, import_jquery2.default)(".pagebreak");
  ...
  (function() {
    ...
    globalThis.addEventListener("DOMContentLoaded", () => {
      ...
      game.createTerminal();
      renderer_default.addFOHackerVersionBeforeInfoInput();
    });
  })();
})();
